...
export class ProgramTypeService implements IProgramTypeService {
   ...
   */
  async get(
    params: IProgramTypeService.GetParams
  ): Promise<Array<ProgramType>> {
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar a busca dos tipos de programas: ${error.message}`
      );
    }
  }
  ...
  async getById(params: IProgramTypeService.GetParams): Promise<ProgramType> {
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar a busca do tipo de programa: ${error.message}`
      );
    }
  }
  ...
  async add(params: IProgramTypeService.AddParams): Promise<ProgramType> {
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar o cadastro de tipo de programa: ${error.message}`
      );
    }
  }
  ...
  async update(params: IProgramTypeService.UpdateParams): Promise<ProgramType> {
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar a atualização de tipo de programa: ${error.message}`
      );
    }
  }
  ...
  async delete(params: IProgramTypeService.DeleteParams): Promise<ProgramType> {
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar a remoção de tipo de programa: ${error.message}`
      );
    }
  }
}
