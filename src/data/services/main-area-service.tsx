...
export class MainAreaService implements IMainAreaService {
    ...
    async get(params: IMainAreaService.GetParams): Promise<Array<MainArea>> {
        ...
        try {
            ...
            throw new Error(`Erro ao realizar a busca das áreas principais: ${error.message}`);
        }
    }
    ...
    async getById(params: IMainAreaService.GetParams): Promise<MainArea> {
        ...
        try {
            ...
            throw new Error(`Erro ao realizar a busca da área principal: ${error.message}`);
        }
    }
    ...
    async add(params: IMainAreaService.AddParams): Promise<MainArea> {
        ...
        try {
            ...
            throw new Error(`Erro ao realizar o cadastro de área principal: ${error.message}`);
        }
    }
    ...
    async update(params: IMainAreaService.UpdateParams): Promise<MainArea> {
        ...
        try {
            ...
            throw new Error(`Erro ao realizar a atualização de área principal: ${error.message}`);
        }
    }
    ...
    async delete(params: IMainAreaService.DeleteParams): Promise<MainArea> {
        ...
        try {
            ...
            throw new Error(`Erro ao realizar a remoção de área principal: ${error.message}`);
        }
    }
}
