...
export class AssistanceTypeService implements IAssistanceTypeService {
   ...
   */
  async get(
    params: IAssistanceTypeService.GetParams
  ): Promise<Array<AssistanceType>> {
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar a busca dos tipos de assistências: ${error.message}`
      );
    }
  }
  ...
  async getById(
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar a busca do tipo de assistência: ${error.message}`
      );
    }
  }
  ...
  async add(params: IAssistanceTypeService.AddParams): Promise<AssistanceType> {
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar o cadastro de tipo de assistência: ${error.message}`
      );
    }
  }
   ...
   */
  async update(
    params: IAssistanceTypeService.UpdateParams
  ): Promise<AssistanceType> {
    const assistanceTypeDTO: AssistanceTypeDTO = {
      name: params.name,
      description: params.description,
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar a atualização de tipo de assistência: ${error.message}`
      );
    }
  }
   ...
   */
  async delete(
    params: IAssistanceTypeService.DeleteParams
  ): Promise<AssistanceType> {
    const httpRequest: HttpRequest = {
      url: `${this.url}/${params.id}`,
      method: "DELETE",
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar a remoção de tipo de assistência: ${error.message}`
      );
    }
  }
}
