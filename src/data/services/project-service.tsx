...
export class ProjectService implements IProjectService {
  ...
  async getOpened(params: IProjectService.GetParams): Promise<Array<Project>> {
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar a busca dos projetos: ${error.message}`
      );
    }
  }
  ...
  async getActivitiesByProjectId(
    params: IProjectService.GetActivitiesParams
  ): Promise<Array<ProjectActivity>> {
    const httpRequest: HttpRequest = {
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar a busca das atividades do projeto: ${error.message}`
      );
    }
  }
  ...
  async add(params: IProjectService.AddParams): Promise<Project> {
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar o cadastro de projeto: ${error.message}`
      );
    }
  }
  ...
  async update(params: IProjectService.UpdateParams): Promise<Project> {
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar a atualização de projeto: ${error.message}`
      );
    }
  }
  ...
  async projectSubmit(params: IProjectService.SubmitParams): Promise<Project> {
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar a submissão do projeto: ${error.message}`
      );
    }
  }
  ...
  async projectAppeal(params: IProjectService.AppealParams): Promise<Project> {
    const requestUrl = `${this.url}/appeal/${
      params.id
    }?appealDescription=${encodeURIComponent(params.appealDescription)}`;
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar a solicitação de recurso para o projeto: ${error.message}`
      );
    }
  }
  ...
  async delete(params: IProjectService.DeleteParams): Promise<Project> {
    ...
    try {
      ...
      throw new Error(
        `Erro ao realizar a remoção de projeto: ${error.message}`
      );
    }
  }
}
